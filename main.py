...
parser.add_argument('--alpha', type=float, default=0.30, metavar='A',
                    help='learning rate (default: 0.30)')
parser.add_argument('--gamma', type=float, default=0.99, metavar='G',
                    help='discount factor (default: 0.99)')
parser.add_argument('--epsilon', type=float, default=0.90, metavar='E',
...
def main():
    ...
    train(params={'alpha': args.alpha, 'gamma': args.gamma,
          'epsilon': args.epsilon}, env=train_env)
